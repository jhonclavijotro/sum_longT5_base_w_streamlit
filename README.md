...
3.2. T5: Unificando Tareas como “Text-to-Text”
...
3.4. Arquitectura del Transformer Base (Encoder-Decoder)
...
3.5. Codificación Posicional Relativa
...
3.7. LongT5: Escalando a Documentos Largos
...
3.7.1. Atención Local (Local Attention)
...
3.7.2. Atención Global Transitoria (Transient Global Attention o TGlobal)
